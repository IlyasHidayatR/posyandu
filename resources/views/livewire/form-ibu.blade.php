        ...
        <div class="card shadow row col col-mb-4" style="width: 18rem; border-radius: 1.5rem">
            <div class="card-body">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-8">
                        <input type="password" class="form-control border border-secondary" id="inputPassword" disabled>
                    </div>
                </div>
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-8">
                        <div class="input-group">
                            <input id="date" type="search" id="form1" class="form-control border border-secondary border-end-0" disabled />
                            <button id="search-button" type="button" class="btn border border-dark border-start-0" style="background-color: #dddddd" disabled>
